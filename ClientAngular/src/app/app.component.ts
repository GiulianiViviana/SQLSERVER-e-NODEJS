...
export class AppComponent {
  ...
  getUnitList(): void {
    ...
    this.obsUnit = this.http.get<Unit[]>('https://3000-cee34e01-3569-40ab-8d56-3a55661e3d47.ws-eu01.gitpod.io/users/all');
...
addUnit(newUnit: HTMLInputElement, newCost: HTMLInputElement, newHitSpeed: HTMLInputElement, newDeployTime: HTMLInputElement,
   ...
   newType: HTMLInputElement, newRarity: HTMLInputElement): boolean {
    ...
    this.postObserver = this.http.post('https://3000-cee34e01-3569-40ab-8d56-3a55661e3d47.ws-eu01.gitpod.io/users/all', JSON.stringify(newData),headers)
